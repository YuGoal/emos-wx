	...
	<view class="page">
		...
		<view class="nav-container">
			<view class="nav-row">
				...
				<view class="nav">
					<image class="icon" src="../../static/nav-3.png" mode="widthFix"></image>
					<text class="name">在线请假</text>
				</view>
				<view class="nav">
					<image class="icon" src="../../static/nav-4.png" mode="widthFix"></image>
					<text class="name">公务出差</text>
				</view>
			</view>
			<view class="nav-row">
				<view class="nav">
					<image class="icon" src="../../static/nav-5.png" mode="widthFix"></image>
					<text class="name">员工日报</text>
				</view>
				<view class="nav">
					<image class="icon" src="../../static/nav-6.png" mode="widthFix"></image>
					<text class="name">我的加班</text>
				</view>
				<view class="nav">
					<image class="icon" src="../../static/nav-7.png" mode="widthFix"></image>
					<text class="name">付款申请</text>
				</view>
				<view class="nav">
					<image class="icon" src="../../static/nav-8.png" mode="widthFix"></image>
